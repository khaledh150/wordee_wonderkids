        ...
        >
          <div className="flex flex-col landscape:grid landscape:grid-cols-2 gap-4 sm:gap-6 items-center landscape:items-stretch text-center landscape:text-left">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <h2 className="text-[10px] font-black text-teal-500 uppercase tracking-widest leading-none">Competition Complete</h2>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-auto min-h-0 relative z-10">
        <span className="absolute top-1 left-2 sm:left-3 lg:left-4 text-xs sm:text-sm lg:text-base font-bold text-teal-400 z-20">Q{currentIndex + 1}/{total}</span>
